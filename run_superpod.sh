...
SAM='--model sam --sharpness --method xdgpm --expt_name sam --rho 0.05'
...
for eta_3 in 0.05 0.07 0.09
do
    CUDA_VISIBLE_DEVICES=1 python main_new.py $CIFAR $SAM --seed $SEED --memories 1000 --lr 0.01 --eta3 $eta_3 --eta2 0.01 --data_path ../
done