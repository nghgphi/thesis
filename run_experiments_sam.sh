...
for seed in 0 1 
do
for rho in 0.05 0.04 0.03 0.02
do
CUDA_VISIBLE_DEVICES=1 python main.py $CIFAR --rho $rho --seed $seed $SAM --memories 1000 --lr 0.01 --eta1 0.001 --eta2 0.01 --data_path ../../../vinai/phinh2
CUDA_VISIBLE_DEVICES=1 python main.py $CSUPER --rho $rho --seed $seed $SAM --memories 1000 --lr 0.01 --eta1 0.001 --eta2 0.01 --data_path ../../../vinai/phinh2
done
done
