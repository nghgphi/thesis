...
class Net(BaseNet):
    ...
    def observe(self, x, y, t, one_task_only:bool=None):
        '''
        ...
        for pass_itr in range(self.glances):
            ...
            for j in range(0, len(x), inner_sz):
                ...
                # samples for sharpness/look-ahead are from the current task  __*__
                ...
                meta_losses[k] = self.meta_loss(bx, by, bt, fast_weights) # 1 lan tren 64 data points
                k += 1
    ...
    def update_weight(self, x, y, t, fast_weights):
        ...
        if fast_weights is None:
            # print("_" * 50)
            # print("Fast weight is None, updated")
