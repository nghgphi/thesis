...
PMNIST='--dataset mnist_permutations --samples_per_task 1000 --workers 4 --batch_size 10 --n_epochs 1 --glances 5 --mem_batch_size 300 --thres 0.99 --thres_add 0.0005 --cuda --earlystop'
CIFAR='--dataset cifar100 --n_tasks 10 --pc_valid 0.05 --batch_size 64 --test_batch_size 64 --n_epochs 4 --mem_batch_size 125 --thres 0.97 --thres_add 0.003 --cuda --freeze_bn --second_order --earlystop'
...
SAM='--model sam --sharpness --method xdgpm --expt_name test_sam_connector --rho 0.05'

# python main.py $PMNIST --seed $SEED $FSDGPM --memories 200 --lr 0.01 --eta1 0.05 --eta2 0.01 
echo 'run file main_new.py'
CUDA_VISIBLE_DEVICES=0 python main_new.py $PMNIST \
                            $SAM \
                            --seed $SEED \
                            --memories 200 \
                            --lr 0.01 \
