...
CIFAR='--dataset cifar100 --n_tasks 10 --pc_valid 0.05 --batch_size 64 --test_batch_size 64 --n_epochs 5 --mem_batch_size 125 --thres 0.97 --thres_add 0.003 --cuda --freeze_bn --second_order --earlystop'
...
SAM='--model sam --sharpness --method xdgpm --expt_name sam_connector_test --rho 0.05'

# python main.py $PMNIST --seed $SEED $FSDGPM --memories 200 --lr 0.01 --eta1 0.05 --eta2 0.01 
echo 'run file main_new.py'
CUDA_VISIBLE_DEVICES=1 python main_new.py $CIFAR \
                            $SAM \
                            --seed $SEED \
                            --memories 1000 \
                            --lr 0.01 \
