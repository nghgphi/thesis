...
PMNIST='--dataset mnist_permutations --samples_per_task 1000 --workers 4 --batch_size 10 --n_epochs 5 --glances 1 --mem_batch_size 300 --thres 0.99 --thres_add 0.0005 --cuda --earlystop'
...
SAM='--model sam --sharpness --method xdgpm --expt_name sam_connector_extra_0406 --rho 0.05'
